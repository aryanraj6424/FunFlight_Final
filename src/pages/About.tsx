...
const trainerSettings = {
 ...
 const flightFeatures = [
  ...
  const testimonials = [
  {
    ...
    content:
      "Excellent instructors and a very professional training environment. I completed my private pilot training here and highly recommend them.",
    rating: 5
  },
  {
    id: 2,
    name: "Sarah Williams",
    content:
      "Great experience from start to finish. The instructors are patient and knowledgeable.",
    rating: 5
  },
  {
    id: 3,
    name: "David Martinez",
    content:
      "Very supportive training program with great aircraft and instructors.",
    rating: 5
  },
  {
    id: 4,
    name: "Emily Clark",
    content:
      "A fantastic place to begin your aviation journey. Highly recommend their discovery flight.",
    rating: 5
  },
  ...
  // ✅ Newly added
  {
    ...
    name: "James Anderson",
    content:
      "Professional training and a friendly environment. The instructors made learning to fly a great experience.",
    rating: 5
  },
  {
    id: 6,
    ...
    content:
      "Highly recommend this school. The team is knowledgeable and supportive throughout the training process.",
    rating: 5
  }
];
